...
clm = '/home/eg/Desktop/EG-WateshedAnalysesAvizo/2023-01-27-B-2-7_LE_recon-borderKill.tif'	# input('Enter label map location: ')
ofl = '/home/eg/Desktop/EG-WateshedAnalysesAvizo/D-2-7/' 									# input('Enter output folder location: ')
sampleName = 'D-2-7'																		# input('Enter sample name: ')
